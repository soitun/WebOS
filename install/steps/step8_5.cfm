<cfoutput>
<!---\\ Step 8: Administration Account //--->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td height="24" colspan="3" background="assets/install_wiz_r2_c8.jpg" class="style1"><b>Step 008: #step_description# </b></td>
       </tr>
     <tr>
       <td width="2%">&nbsp;</td>
       <td width="96%"><form name="step8_5" action="?step=9" method="post">
              <p>
       ...
       <input type="hidden" name="site_email" value="#form.site_email#" />
                ...
                <cfquery name="create_admin" datasource="#form.datasrc#">
       insert into webos_admins (username, password, name, permissions) values ('#form.username#', '#form.password#', '#form.name#', '1')
       </cfquery>
                </p>
              <p>We have successfully created your Adminsitrator Account!<br />
           ...
           <tr>
             ...
             <td height="20" class="Button"><a href="javascript: document.step8_5.submit();" class="Button">Step 9 &gt;&gt;</a></td>
