...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
       <td width="2%">&nbsp;</td>
       <td width="96%">Please Wait As We Verify your DSN...
         <hr />
       <form name="step6" method="post" action="?step=7">
       ...
       <!---\\ End of Configurables //---><br />
<cfset dsService = CreateObject("java", "coldfusion.server.ServiceFactory").DataSourceService>

<cfif dsService.verifyDatasource("#form.datasrc#")>
	<font color="##006600"> Your Datasource <b><i>#form.datasrc#</i></b> Has been Verified!</font><br /><br />
    </form>
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="48%">What do you want to do:</td>
    <td width="2%">&nbsp;</td>
    <td>
    <input name="next" type="radio" value="1" onclick="document.step6.submit()"/>Create and Import Database<br />
    <!---(If you already have WebOS Tables they will be deleted)--->
    <form name="step6_5" method="post" action="?step=9">
       <!---\\ Configurables from Steps 2 //--->
       <input type="hidden" name="site_domain" value="#form.site_domain#"/>
       <input type="hidden" name="site_folder" value="#form.site_folder#" />
       <input type="hidden" name="site_name" value="#form.site_name#" />
    ...
    <input name="next" type="radio" value="2" onclick="document.step6_5.submit()"/>Update Site Configuration  </td>
  </tr>
</table>
...
<cfelse>
	<font color="##990000"> Your DataSource #form.datasrc# was not Verfified...</font><br /><br />
    Go <a href="?step=4"> Back</a> and make sure your data source is correct.
    </cfif>
</td>
</tr>
</table>
