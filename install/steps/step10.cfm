...
<cfif #form.site_template# EQ "WebOS-Silver">
<cfquery name="insert_config" datasource="#form.datasrc#">
...
<cfelseif #form.site_template# NEQ "WebOS-Silver">
<cfquery name="insert_config" datasource="#form.datasrc#">
...
update webos_modules set module_installed='#form.inquiry#' where module_name='Inquiry Form'
