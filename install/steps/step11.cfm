         ...
         <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
           ...
           <tr>
             ...
             <td width="48%"><table border="0" align="center" cellpadding="0" cellspacing="0" class="ButtonTable">
               <tr>
                 ...
                 <td height="20" class="Button"><a href="http://#form.site_domain##form.site_folder#" target="_blank" class="Button">Goto Front-End</a></td>
           ...
           <tr>
             ...
             <td width="48%"><table border="0" align="center" cellpadding="0" cellspacing="0" class="ButtonTable">
               <tr>
                 <td width="7" height="20"><img src="assets/button/button_left.gif" width="7" height="20" /></td>
                 <td height="20" class="Button"><a href="http://#form.site_domain##form.site_folder##site_admin_dir#" target="_blank" class="Button">Goto Administration Panel</a></td>
                 <td width="7" height="20"><img src="assets/button/button_right.gif" width="7" height="20" /></td>
               </tr>
             </table></td>
           </tr>
