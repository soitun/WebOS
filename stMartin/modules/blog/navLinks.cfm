...
Created by James Harvey (jchharvey@gmail.com)
	      ...
	      <cftransaction>
        	<cfquery datasource="#datasrc#" Name="addComment">
			    INSERT INTO #table_blog_comments# (cbid, cName, cLink, cEmail, cCom, cStatus, cSubscribe, SiteID)
				VALUES (#id#, '#inname#', '#inlink#', '#inemail#', '#incomment#', 1, #insubscribe#, <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#">)
			</cfquery>
      	</cftransaction>
