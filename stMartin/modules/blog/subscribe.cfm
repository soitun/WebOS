    ...
    <cfif #get_email.RecordCount# EQ 1>
      ...
      <CFTRANSACTION>
        <CFQUERY DataSource="#datasrc#" Name="addemail">
			    INSERT INTO #table_blog_news# (neEmail, neToken, neStatus, neDomain, SiteID)
				VALUES ('#nemail#', '#token#', 0, '#domain#', <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#">)
			</CFQUERY>
      </CFTRANSACTION>
