...
SELECT ThreadCount,ThreadEnd, EntryID, PostNum, Author, CreateDate, Title,Thread FROM #table_forum_entries# WHERE PostNum = #PostNum#
AND SiteID = <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#"> ORDER BY Thread
</cfquery>
