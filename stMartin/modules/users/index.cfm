...
insert into #table_usrs# (id, username, password, emailaddress, sign_up_date, siteID) values ('#CreateUUID()#', '#form.username_new#', '#form.password_new#', '#form.emailaddress#', '#dateformat(now(), "MM/DD/YYYY")#', <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#">)
</cfquery>
</cfif>
</cftransaction>
</cfif>
