...
insert into #table_inquiry_submit# (subject, field_001, field_002, field_003, field_004, field_005, field_006, field_007, field_008, field_009, field_010, field_011, field_012, field_013, field_014, field_015, replied_to, date_submitted, SiteID) VALUES ('#form.subject#','#form.field_1#', '#form.field_2#', '#form.field_3#','#form.field_4#',<cfif isDefined('form.field_5')>'#form.field_5#',<cfelseif NOT isDefined('form.field_5')>'',</cfif><cfif isDefined('form.field_6')>'#form.field_6#',<cfelseif NOT isDefined('form.field_6')>'',</cfif> <cfif isDefined('form.field_7')>'#form.field_7#',<cfelseif NOT isDefined('form.field_7')>'',</cfif><cfif isDefined('form.field_8')>'#form.field_8#',<cfelseif NOT isDefined('form.field_8') >'',</cfif><cfif isDefined('form.field_9')>'#form.field_9#',<cfelseif NOT isDefined('form.field_9')>'',</cfif><cfif isDefined('form.field_10')>'#form.field_10#',<cfelseif NOT isDefined('form.field_10')>'',</cfif><cfif isDefined('form.field_11')>'#form.field_11#',<cfelseif NOT isDefined('form.field_11')>'',</cfif><cfif isDefined('form.field_12')>'#form.field_12#',<cfelseif NOT isDefined('form.field_12')>'',</cfif><cfif isDefined('form.field_13')>'#form.field_13#',<cfelseif NOT isDefined('form.field_13')>'',</cfif><cfif isDefined('form.field_14')>'#form.field_14#',<cfelseif NOT isDefined('form.field_14')>'',</cfif><cfif isDefined('form.field_15')>'#form.field_15#',<cfelseif NOT isDefined('form.field_15')>'',</cfif>'0', <cfif #db_type# EQ "mssql">'#dateformat(now(), "MM/DD/YYYY")#'<cfelseif #db_type# EQ "mysql">'#dateformat(now(), "YYYY-MM-DD")#' </cfif>, <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#">)
</cfquery>
</cftransaction>
...
<div id="welcome" class="post">
  ...
  <tr>
    ...
    select * from #table_inquiry_sel# where field_id='#inquiry_fields.field_id#' 
    AND SiteID = <cfqueryparam cfsqltype="cf_sql_char" value="#session.SiteID#">
    order by field_selected DESC
    </cfquery>
