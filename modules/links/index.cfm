...
<cfset visits = GetLink2.visits+1>
<cfquery name="updatelink" datasource="#datasrc#">
Update #table_links#
set visits=#visits#
where link_id = #url.id#
</cfquery>
<cflocation url="#GetLink2.link#" addtoken="no">
</cfif>
...
FROM dbo.#table_links# where link_cat='#cat#'
</cfquery>
