...
<div id="menu_box" style="text-align:left;">
...
<cfelse>
&nbsp;<img src="http://<cfoutput>#site_domain##site_folder##site_template_dir##site_template#/#site_assets_dir#</cfoutput>page_menu_bullet.jpg" alt="Home" width="7" height="12">
&nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm" class="menu_items">Home</a><br />
</cfif>
<cfif module_inquiry EQ "1">
  ...
  <cfelse>
  &nbsp;<img src="http://<cfoutput>#site_domain##site_folder##site_template_dir##site_template#/#site_assets_dir#</cfoutput>page_menu_bullet.jpg" alt="Home" width="7" height="12">
  &nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=inquiry" class="menu_items">Contact Us</a><br />
  </cfif>
  </cfif>
<cfoutput>
...
<b>&nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=sitemap&view=map" class="menu_items">Sitemap</a></b><br />
  ...
  &nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=sitemap&view=map" class="menu_items">SiteMap</a><br />     
     </cfif>
...
<b>&nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=podcasts" class="menu_items">PodCasts</a></b><br />
  <cfelse>
  &nbsp;<img src="http://<cfoutput>#site_domain##site_folder##site_template_dir##site_template#/#site_assets_dir#</cfoutput>page_menu_bullet.jpg" alt="Sitemap" width="7" height="12">
  &nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=podcasts" class="menu_items">PodCasts</a><br />     
     </cfif>
     </cfif>     
...
<b>&nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=polls" class="menu_items">Polls</a></b><br />
  <cfelse>
  &nbsp;<img src="http://<cfoutput>#site_domain##site_folder##site_template_dir##site_template#/#site_assets_dir#</cfoutput>page_menu_bullet.jpg" alt="Sitemap" width="7" height="12">
  &nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=polls" class="menu_items">Polls</a><br />     
     </cfif>
     </cfif>     
...
<b>&nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=tellafriend" class="menu_items">Tell-A-Friend</a></b><br />
  <cfelse>
  &nbsp;<img src="http://<cfoutput>#site_domain##site_folder##site_template_dir##site_template#/#site_assets_dir#</cfoutput>page_menu_bullet.jpg" alt="Sitemap" width="7" height="12">
  &nbsp;<a href="http://<cfoutput>#site_domain##site_folder#</cfoutput>index.cfm?module=tellafriend" class="menu_items">Tell-a-Friend</a><br />     
     </cfif>
     </cfif>    
