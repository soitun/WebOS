...
<cfparam name="attributes.page" default="Spotlights Adminsitration">
...
<CFTRANSACTION>
 <CFQUERY DataSource="#datasrc#" Name="add_spotlight">
  ...
  VALUES ('#form.spotlight_title#', <cfif isDefined('form.#editor_name#')>'#form.spotlightcontent#',<cfelseif NOT isDefined('form.#editor_name#')>'#form.spotlightcontentAdv#',</cfif> '#form.spotlight_time_sensitive#', '#form.spotlight_start#', '#form.spotlight_expire#')
 </CFQUERY>
</CFTRANSACTION>
