...
<tr><td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<cfif do EQ "m">
    <!---\\ Intro Text //--->
    Welcome <b><cfoutput>#session.user#</cfoutput></b>, to the WebOS <b><cfoutput>#attributes.page#</cfoutput></b> Page. Here you can modify your WebOS Settings and View your Environment Variables.
...
<li><a href="#" rel="tcontent2">Templates Config</a></li>
...
<cfoutput query="#table_config#" >
 <tr <CFIF row_color EQ 1>bgcolor="##efefef"</CFIF>>
    <td  align="left" valign="top">#configuration_title#</td>
    <td align="left" valign="top">#configuration_description#</td>
    <td align="right" valign="top" >#left(configuration_value, 15)#</td>
...
<cfoutput query="templates_config" >
 <tr <CFIF row_color EQ 1>bgcolor="##efefef"</CFIF>>
    <td align="left" valign="top">#configuration_title#</td>
    <td align="left" valign="top">#configuration_description#</td>
    <td align="left" valign="top">#configuration_value#</td>
    <td align="right" valign="top"><cfif #configuration_title# EQ "Site Configured">
    <cfelseif #configuration_title# EQ "Site License">
    <cfelseif #configuration_title# EQ "Data Source">
    <cfelseif #configuration_title# EQ "WebOS Version">
