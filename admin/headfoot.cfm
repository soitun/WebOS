...
//Menu Items: Website Modules:
//Menu Items: Website Templates:
//Menu Items: Website Users:
//Menu Items: Website Utilities:
...
<layer id="d2" width="100%" height="20">
            ...
            <b>Topic Help::</b> Mouse over a menu item to your left to view available options.
              ...
              <br>
              Welcome <b><cfoutput>#session.name#</cfoutput></b> to the <cfoutput>#attributes.script#</cfoutput>. From Here you can easily administrate your WebOS Website as needed. </td>
            <td width="2%">&nbsp;</td>
          </tr>
        </tbody>
      </table></td>
...
select configuration_value from #table_config# where configuration_key ='webos_version'
              ...
              <strong>WebOS<sup>V.<cfoutput>#version.configuration_value#</cfoutput></sup> Adminsitration Panel Interface Copyright &copy; 2007-2008 WebOS. All Rights Reserved.<!--originally Design and Developed By James Harvey--></strong>
            </center>
              </td>
            <td width="2%">&nbsp;</td>
          </tr>
