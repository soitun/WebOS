...
<cfparam name="attributes.page" default="Newsletter Adminsitration">
...
<cfif isDefined('url.send') and #url.send# is "yes">
  ...
  VALUES ('#form.subject#', <cfif isDefined('form.#editor_name#')>'#form.newslettercontent#',<cfelseif NOT isDefined('form.#editor_name#')>'#form.newslettercontentAdv#',</cfif> '#dateformat(now(), "mm/dd/yyyy")#')
			</CFQUERY>
  </cfif>
  </CFTRANSACTION>
  <cflocation url="module_newsletter.cfm?do=m" addToken="No">
