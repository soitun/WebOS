...
<cfparam name="attributes.page" default="Main Page Adminsitration">
...
<CFTRANSACTION>
 <CFQUERY DataSource="#datasrc#" Name="add_article">
  ...
  VALUES ('#form.main_page_title#', <cfif isDefined('form.#editor_name#')>'#form.mainpagecontent#',<cfelseif NOT isDefined('form.#editor_name#')>'#form.mainpagecontentAdv#',</cfif> '#form.main_page_time_sensitive#', '#form.main_page_start_date#', '#form.main_page_expire_date#', '#form.main_page_active#')
  </CFQUERY>
</CFTRANSACTION>
...
<cfif isDefined('url.Update') and #url.Update# is "yes">
  ...
  UPDATE #table_mainpage# SET main_page_title='#form.main_page_title#', main_page_content=<cfif isDefined('form.#editor_name#')>'#form.mainpagecontent#',<cfelseif NOT isDefined('form.#editor_name#')>'#form.mainpagecontentAdv#',</cfif> main_page_time_sensitive='#form.main_page_time_sensitive#', main_page_start_date='#form.main_page_start_date#', main_page_expire_date='#form.main_page_expire_date#', main_page_active='#form.main_page_active#'  WHERE main_page_id = '#form.main_page_id#'  
			</CFQUERY>
  </CFTRANSACTION>
  <cflocation url="module_mainpage.cfm?do=m" addToken="No">
</cfif>  
