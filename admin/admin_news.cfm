...
<cfparam name="attributes.page" default="WebOS Administration Panel News Adminsitration">
...
<CFTRANSACTION>
 <CFQUERY DataSource="#datasrc#" Name="add_article">
  ...
  VALUES ('#form.news_title#', <cfif isDefined('form.#editor_name#')>'#form.adminnewscontent#',<cfelseif NOT isDefined('form.#editor_name#')>'#form.adminnewscontentAdv#',</cfif> '#form.news_date#')
  </CFQUERY>
</CFTRANSACTION>
