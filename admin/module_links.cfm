...
<cfparam name="attributes.page" default="Links Directory Adminsitration">
...
<cfif isdefined("form.link_img") and #form.link_img# NEQ ""> 
  ...
  <cffile action="upload" filefield="link_img" destination="C:\inetpub\wwwroot\_local_dev\_webos\templates\#site_template#\modules\links\link_img\" nameconflict="overwrite" accept="image/*" > 
  <cfset uploadedfile = "C:\inetpub\wwwroot\_local_dev\_webos\templates\#site_template#\modules\links\link_img\#file.serverfile#"> 
...
<cfif isdefined("form.link_cat_img") and #form.link_caT_img# NEQ ""> 
  <!---  The uploadfile destination path is declared as a variable in the application.cfm file you may need to verify the precise path with your host ---> 
  <cffile action="upload" filefield="link_cat_img" destination="C:\inetpub\wwwroot\_local_dev\_webos\templates\#site_template#\modules\links\cat_img\" nameconflict="overwrite" accept="image/*" > 
  <cfset uploadedfile = "C:\inetpub\wwwroot\_local_dev\_webos\templates\#site_template#\modules\links\cat_img\#file.serverfile#"> 
  <!---<cfoutput>#file.ServerFile#</cfoutput>--->
    </cfif>
  <CFTRANSACTION>
