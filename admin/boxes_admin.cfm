...
<tr><td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100" valign="top"><img src="assets/modules/modules_boxes.jpg" alt="WebOS Site Configuration" width="100" height="100" /></td>
 ...
 <cfoutput>#url.msg#</cfoutput>
    ...
    <hr width="95%" align="center"/>
       <cfquery name="site_boxes" datasource="#datasrc#">
select * from #table_sideboxes# Order by side_box_Active, side_box_position
</cfquery>
